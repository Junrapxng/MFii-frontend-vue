...
<v-app>
    ...
    <v-main>
        <main>
            ...
            <!-- Youtube video -->
            <div class="youtube">
                <iframe class="videos" height="260" width="450" src="https://www.youtube.com/embed/dQw4w9WgXcQ" title=" &amp; Pagination part 5/7" frameborder="0" allow="autoplay" allowFullScreen></iframe>
                <iframe class="videos" height="260" width="450" src="https://www.youtube.com/embed/dQw4w9WgXcQ" title=" &amp; Pagination part 5/7" frameborder="0" allow="autoplay" allowFullScreen></iframe>
                <iframe class="videos" height="260" width="450" src="https://www.youtube.com/embed/dQw4w9WgXcQ" title=" &amp; Pagination part 5/7" frameborder="0" allow="autoplay" allowFullScreen></iframe>
            </div>

            <!-- Content -->
            <div class="inputSearch flex w-80 ml-5">
                <v-text-field label="Search" variant="outlined" placeholder="Search something..."></v-text-field>
                <v-btn class="button mt-2" type="submit">Search</v-btn>
            </div>
            <div class="wrap">
                <div class="card-container">
                    ...
                    <router-link v-else v-for="data in info" :key="data.id || data.plant_name" :to="{ name: 'Innovation', params: { id: data.id } }" class="item mx-1">
