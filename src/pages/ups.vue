      ...
      <v-container class="font-noto-sans-thai text-gray-600">
        ...
        <v-carousel height="500" show-arrows="hover" cycle hide-delimiter-background>
          <v-carousel-item v-for="(slide, i) in images" :key="i">
            <v-img class="carousel__item mx-auto" max-height="500" lazy-src="" :src="slide.image" cover
              @loadstart="loading[i] = true" @load="loading[i] = false" @error="loading[i] = false">
        ...
        <div class="youtube d-flex justify-center overflow-auto">
          <iframe class="videos mx-5" height="260" width="450" src="https://www.youtube.com/embed/dQw4w9WgXcQ"
