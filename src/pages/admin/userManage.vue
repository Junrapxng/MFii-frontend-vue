...
export default {
  ...
  methods: {
    ...
    async fectchUser() {
      try {
        const response = await axios.get("http://172.26.0.3:7770/admin/getsUser", {
          headers: {
    ...
    async deleteItemConfirm() {
      ...
      try {
        const res = await axios.delete(
          "http://172.26.0.3:7770/admin/deleteUser/" + this.editedItem._id, {
          headers: {
            Authorization: localStorage.getItem("token"),
          },
        }
    ...
    async editsave() {
      ...
      if (this.editedIndex > -1) {
        ...
        try {
          await axios.patch(
            "http://172.26.0.3:7770/admin/updatePatch/" + this.editedItem._id, {
