<template>
  <v-app>
    ...
    <v-main>
      ...
      <v-container
        class="font-noto-sans-thai rounded-xl flex justify-center items-center bg-gray-100 mb-6"
      >
        <v-card class="w-full max-w-lg rounded-xl p-8">
          <v-card-title>
            <h2 class="text-2xl font-semibold mb-2">
              <v-icon class="align-baseline" style="font-size: 28px"
                >mdi-account</v-icon
              >
              เข้าสู่ระบบ
            </h2>
          ...
          <v-card-text>
            <v-form @submit.prevent="login" ref="form">
              ...
              <v-btn class="rounded-xl" type="submit" color="#BA984C" s block
                >เข้าสู่ระบบ</v-btn
              >
              <div
                class="text-center justify-space-between pt-5 flex text-base"
              >
                <v-checkbox
                  v-model="checkbox"
                  label="Remember Me"
